...
@Component({
  ...
  templateUrl: './dashboard-infirmerie.component.html',
  styleUrls: ['./dashboard-infirmerie.component.scss']
})
export class DashboardInfirmerieComponent implements OnInit {
