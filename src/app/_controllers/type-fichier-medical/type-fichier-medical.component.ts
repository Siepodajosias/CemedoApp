...
import { TypeFichierService } from 'src/app/_services/type-fichier/type-fichier.service';

@Component({
  selector: 'app-type-fichier-medical',
  templateUrl: './type-fichier-medical.component.html',
  styleUrls: ['./type-fichier-medical.component.scss'],
  providers: [MessageService,ConfirmationService,DialogService]
})
export class TypeFichierMedicalComponent implements OnInit {

  liste: TypeFichierMedical[] ;
  specialite: TypeFichierMedical;
  entityDialog: boolean;
  totalRecords: number;
  loading: boolean;
  selectedEntity: TypeFichierMedical[];
  submitted: boolean;
  ...
  constructor(public dialogService: DialogService,private service: TypeFichierService,private messageService: MessageService, private confirmationService: ConfirmationService) { }
  ngOnInit() {
    this.cols = [
  ...
  editProduct(specialite: TypeFichierMedical) {
    this.specialite = {...specialite};
    this.entityDialog = true;
  }
  
  deleteProduct(specialite: TypeFichierMedical) {
    this.confirmationService.confirm({
