...
export class FactureComponent implements OnInit {
  ...
  constructor(public dialogService: DialogService,private service: FactureService,private messageService: MessageService, private confirmationService: ConfirmationService) { }
  ngOnInit() {
    this.cols = [
      { field: "id", header: "Identifiant" },
      { field: "dateEmission", header: "Nom" },
      { field: "montant", header: "Prenoms" },
      { field: "assure", header: "Telephone" },
      { field: "modePaiement", header: "Email" },
