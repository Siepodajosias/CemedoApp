...
import { InfirmierService } from 'src/app/_services/infirmier/infirmier.service';
@Component({
...
export class InfirmierComponent implements OnInit {
  ...
  constructor(public dialogService: DialogService,private service: InfirmierService,private messageService: MessageService, private confirmationService: ConfirmationService) { }
  ngOnInit() {
    this.cols = [
  ...
  editProduct(specialite: Infirmier) {
    this.specialite = {...specialite};
    this.entityDialog = true;
  }
  
  deleteProduct(specialite: Infirmier) {
    this.confirmationService.confirm({
