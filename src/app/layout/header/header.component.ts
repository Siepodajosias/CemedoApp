  ...
  implements OnInit, AfterViewInit
{
  ...
  listLang = [
    ...
    { text: "cote d'ivore", flag: "assets/images/flags/ci.jpg", lang: "fr" },
  ];
  notifications: any[] = [
    {
  ...
  ngOnInit() {
    ...
    if (userRole === "Admin") {
      ...
      this.homePage = "comptable/dashboard/main";
    } else if (userRole === "Infirmier") {
      this.homePage = "infirmerie/dashboard";
    } else if (userRole === "Pharmacien") {
      this.homePage = "pharmacie/dashboard";
    } else if (userRole === "Reception") {
      this.homePage = "reception/dashboard";
    } else if (userRole === "Assurance") {
      this.homePage = "assurance/dashboard";
    } else if (userRole === "Informaticien") {
      this.homePage = "informatique/dashboard";
